        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="http://baidu.com"><i
                            class="icon-home icon-white"></i> 俺们图书馆 <span class="sml_t">2.0</span></a>
                    ...
                    <ul class="nav user_menu pull-right">
                        ...
                        <li class="dropdown"><a href="#" class="dropdown-toggle"
                            ...
                            <#if suser??>
                            <img src="user?action=pic&id=${suser.id}" alt="请登录" class="user_avatar" />
                           ${suser.username}
                            <#elseif auser??>

                                    <img src="admin?action=pic&id=${auser.id}" alt="请登录" class="user_avatar" />
                                ${auser.ausername}
                            <#else >
                    ...
                    <#if !auser??&&!suser??>
                                <li><a data-toggle="modal" id="my"
                                       ...
                                       href="#login" title="登录"
                                       onclick="javascript:document.getElementById('submenu').innerHTML='登录'">学生登录
                                </a></li>
                    </#if>
<#if  auser??>
                   <li><a data-toggle="modal" id="my"
                           data-backdrop="static"
                           href="#rshow" title="登录"
                            onclick="javascript:document.getElementById('submenu').innerHTML='登录'">根据书名借书
                    </a></li>    </#if>

                <#if  auser??>
                    <li><a data-toggle="modal" id="my"
                           data-backdrop="static"
                           href="#addbook" title="增加书"
                           onclick="javascript:document.getElementById('submenu').innerHTML='增加书'">增加书
                    </a></li>
                </#if>
                    ...
                    <#if  !auser??&&!suser??>
                                <li><a data-toggle="modal" id="my"
                                       data-backdrop="static"
                                       href="#alogin" title="登录"
                                       onclick="javascript:document.getElementById('submenu').innerHTML='登录'">管理员登录
                                </a></li></#if>

          <li><a data-toggle="modal" id="my"
                 data-backdrop="static"
                                       href="#register" title="学生注册"
                                       onclick="javascript:document.getElementById('submenu').innerHTML='注册'">学生注册</a>
                    </li>
                        <li><a data-toggle="modal" id="my" data-backdrop="static"
                               href="#aregister" title="管理员注册"
                               onclick="javascript:document.getElementById('submenu').innerHTML='注册'">管理员注册</a>
                ...
                <#if auser??>
                    <li><a href="admin?action=out"
                           onclick="javascript:document.getElementById('submenu').innerHTML=''">退出当前用户</a></li>
                </ul></li>   </#if>
                <#if auser??>
                    <li><a href="borrow?action=queryall&cur=0"
                           onclick="javascript:document.getElementById('submenu').innerHTML=''">还书</a></li>
                    </ul></li>    </#if>
...
<script type="text/javascript">
    ...
    function alogin() {
        ...
        document.all.alogin_form.submit();
...
*/
    ...
    */
    ...
    function aupload() {
        ...
        document.all.aFile_form.submit();

    }
    function aregister() {


        if (document.all.areusername.value == '') {

            document.getElementById("sticky_a1").click();
            return;
        }
        if (document.all.arepassword.value == '') {

            document.getElementById("sticky_a2").click();
            return;
        }

        if (document.all.arepassword.value.length <6) {

            document.getElementById("sticky_a9").click();
            return;
        }
        if (document.all.arerepassword.value == '') {

            document.getElementById("sticky_a3").click();
            return;
        }
        if (document.all.arerepassword.value.length <6) {

            document.getElementById("sticky_a10").click();
            return;
        }

        if (document.all.arerepassword.value != document.all.arepassword.value) {
